...
pub struct ServerConfig {
    ...
    /// Command on the server where to execute for packet capturing
    pub traffic_monitor_cmd: String,
    ...
    pub traffic_monitor_log: String,
